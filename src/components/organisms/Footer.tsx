		...
		<footer className="overflow-hidden pt-28 md:pt-44">
			<div className="mb-12 flex items-center justify-end px-6 lg:px-8">
				<div className="relative flex items-end justify-end gap-2 md:gap-4 lg:gap-6">
					...
					<a
						className="relative m-0 ml-auto break-all p-0 font-montserrat text-2xl font-light text-gray-900 underline transition-colors hover:text-gray-700 md:text-3xl lg:text-4xl xl:text-6xl xl:tracking-3"
						href="mailto:contact@climatetechconnect.nl"
					>
						contact@climatetechconnect.nl
					</a>
					<SmileyFace className="hidden sm:block sm:w-8 md:w-10 xl:w-14" />
				</div>
			</div>
